...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        Schema::create('customer_contact', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('customer_id')->index('fk_customer_pk');
            $table->unsignedInteger('contact_id')->index('fk_contact_pk');
            $table->enum('type', ['Billing', 'NonBillingPrimary', 'NonBillingSecondary'])->nullable();
            $table->dateTime('created_at')->nullable();
            $table->dateTime('updated_at')->nullable();
        });
    }
