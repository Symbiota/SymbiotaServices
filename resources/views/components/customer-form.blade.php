...
<form hx-post={{ url('/customer') }} hx-target="#customer-list-div" hx-swap="outerHTML" x-show = "show">
    ...
    <div class="space-y-12" x-show="show">
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="sm:col-span-4">
                    <label for="darbi_customer_account_number" class="block text-sm/6 font-medium text-gray-900">Darbi
                    ...
                    <div class="mt-2">
                        <div
                            ...
                            <input type="text" name="darbi_customer_account_number"
                                ...
                                class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 border border-gray-500"
                                placeholder="1234" value="{{ $customer->darbi_customer_account_number ?? '' }}"
                                required>
                        </div>
