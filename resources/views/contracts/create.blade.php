        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <x-form-box for="customer_id" class="-mt-8"> Customer ID*
                    <x-form-input type="text" name="customer_id" id="customer_id" value="{{ old('customer_id') ?? $customer->id ?? ''}}"></x-form-input>
                        @error('customer_id')
                ...
                <x-form-box for="original_contact_id"> Original Contact ID*
                    <x-form-input type="text" name="original_contact_id" id="original_contact_id" value="{{ old('original_contact_id') }}"></x-form-input>
                ...
                <x-form-box for="darbi_header_ref_1"> Darbi Header Ref 1*
                    <x-form-input type="text" name="darbi_header_ref_1" id="darbi_header_ref_1" value="{{ old('darbi_header_ref_1') }}"></x-form-input>
                ...
                <x-form-box for="darbi_header_ref_2"> Darbi Header Ref 2
                    <x-form-input type="text" name="darbi_header_ref_2" id="darbi_header_ref_2" value="{{ old('darbi_header_ref_2') }}"></x-form-input>
                ...
                <x-form-box for="darbi_special_instructions"> Darbi Special Instructions
                    <x-form-input type="text" name="darbi_special_instructions" id="darbi_special_instructions" value="{{ old('darbi_special_instructions') }}"></x-form-input>
                ...
                <x-form-box for="notes"> Notes
                        <x-form-input type="text" name="notes" id="notes" value="{{ old('notes') }}"></x-form-input>
                        @error('notes')
                            <p class="text-red-500 text-sm ml-3">{{ $message }}</p>
                        @enderror
                </x-form-box>
                ...
                <x-form-box for="start_date"> Start Date*
                        <x-form-input type="text" name="start_date" id="start_date" placeholder="YYYY-MM-DD" value="{{ old('start_date') }}"></x-form-input>
                        @error('start_date')
                            <p class="text-red-500 text-sm ml-3">{{ $message }}</p>
                        @enderror
                </x-form-box>
                ...
                <x-form-box for="end_date"> End Date*
                        <x-form-input type="text" name="end_date" id="end_date" placeholder="YYYY-MM-DD" value="{{ old('end_date') }}"></x-form-input>
                        @error('end_date')
                            <p class="text-red-500 text-sm ml-3">{{ $message }}</p>
                        @enderror
                </x-form-box>
